...
use ggez::graphics::{Color, Text, Font, Scale, Mesh, MeshBuilder, DrawMode, Rect, DrawParam};
...
impl Button {
    ...
    pub fn draw(&self, context: &mut Context) -> GameResult<()> {
        ...
        graphics::draw(context, &self.text, DrawParam::default().dest(self.text_location).color(self.text_color))?;
